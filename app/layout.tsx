  ...
  return (
    ...
    >
      ...
      <body className="min-h-full flex flex-col bg-background text-foreground">
        <ga-header>
          {/* Brand link is nested in a <span slot="brand"> on purpose: the
              header's ::slotted(a) !important rule only matches TOP-LEVEL
              slotted nodes, so nesting lets the link inherit the brand
              container's foreground colour + fg->muted hover instead. */}
          <span slot="brand">
